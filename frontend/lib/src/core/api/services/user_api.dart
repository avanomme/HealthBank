...
abstract class UserApi {
  ...
  @GET('/users/') // explicitly target '/' endpoint to avoid CORS issues
  ...
  /// Create a new user
  @POST('/users/') // trailing slash avoids 307 redirect from FastAPI
  ...
  @PUT('/users/me')
  Future<User> updateCurrentUser(@Body() CurrentUserUpdate user);
