...
class _MessagingApi implements MessagingApi {
  _MessagingApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ConversationCreated> createConversation(
    ...
    _data.addAll(body);
    final _options = _setStreamType<ConversationCreated>(
    ...
    late ConversationCreated _value;
    try {
      _value = ConversationCreated.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<MessageCreated> sendMessage(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<MessageCreated>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/messages/conversations/${convId}/messages',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MessageCreated _value;
    try {
      _value = MessageCreated.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<List<ResearcherResult>> getFriends() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ResearcherResult>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/messages/friends',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ResearcherResult> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ResearcherResult.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  Future<void> sendDirectFriendRequest(Map<String, dynamic> body) async {
    ...
    final _options = _setStreamType<void>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/messages/friend-request/direct',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<List<FriendRequest>> getIncomingFriendRequests() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<FriendRequest>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/messages/friend-requests/incoming',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<FriendRequest> _value;
    try {
      _value = _result.data!
  ...
  Future<void> respondToFriendRequest(
    ...
    final _options = _setStreamType<void>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/messages/friend-requests/${requestId}/respond',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<void> deleteMessage(int convId, int messageId) async {
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/messages/conversations/${convId}/messages/${messageId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
