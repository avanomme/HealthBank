...
class _QuestionApi implements QuestionApi {
  ...
  Future<List<QuestionCategory>> listCategories() async {
    ...
    final _options = _setStreamType<List<QuestionCategory>>(
    ...
    late List<QuestionCategory> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => QuestionCategory.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<Question> createQuestion(QuestionCreate question) async {
    ...
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = question;
    final _options = _setStreamType<Question>(
