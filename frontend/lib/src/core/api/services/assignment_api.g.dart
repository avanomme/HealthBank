...
class _AssignmentApi implements AssignmentApi {
  _AssignmentApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<MyAssignment>> getMyAssignments({String? status}) async {
    ...
    final _options = _setStreamType<List<MyAssignment>>(
    ...
    late List<MyAssignment> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => MyAssignment.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<BulkAssignmentResult> assignSurveyBulk(
    ...
    _data.addAll(body);
    final _options = _setStreamType<BulkAssignmentResult>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/surveys/${surveyId}/assign',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BulkAssignmentResult _value;
    try {
      _value = BulkAssignmentResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
