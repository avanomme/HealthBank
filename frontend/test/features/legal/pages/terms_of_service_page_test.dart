...
void main() {
  group('TermsOfServicePage', () {
    ...
    group('Content rendering', () {
      ...
      testWidgets('displays placeholder terms text', (tester) async {
        _useDesktopViewport(tester);
        ...
        // Should display the placeholder text
        expect(find.byType(Text), findsWidgets);
      });
    ...
    group('Multi-role scenarios', () {
      testWidgets('participant can view terms of service', (tester) async {
        _useDesktopViewport(tester);
      ...
      testWidgets('researcher can view terms of service', (tester) async {
        _useDesktopViewport(tester);
      ...
      testWidgets('hcp can view terms of service', (tester) async {
        _useDesktopViewport(tester);
